...
/**
 * This class reads the data created from the RainfallDataCreationEx6 class using java.io.DataInputStream.
 * It displays all the data and computes the average rainfall for each station.
 * 
 * 
 * @author irdinafarisya
 */
public class RainfallDataConsumptionEx6 {

    public static void main(String[] args) {

        // Declare input file
        String sourceFile = "RainfallDataEx6.txt";
